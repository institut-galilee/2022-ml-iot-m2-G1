...
def recognizer():
    ...
    # Partie pour le portage sur d'autres os
    if my_os == "Windows":
    ...
    if my_os == "Windows":
        picfile = "ml_facecalm\\labels.pickle"
    else:
        picfile = "ml_facecalm/labels.pickle"
    ...
    if my_os == "Windows":
        ymlfile = "ml_facecalm\\trainer.yml"
    else:
        ymlfile = "ml_facecalm/trainer.yml"    
    recognizer.train(x_train, np.array(y_labels))
    recognizer.save(ymlfile)